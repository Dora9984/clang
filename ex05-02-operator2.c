...
int main(void)
{
    ...
    // 비트 연산자
    printf("비트 연산자\n");
    int a = 3; // 3(10) -> 0 0011(2)
    int b = 5; //5(10) -> 0 0101(2)
    ...
    // 후위 증감연산자
    int j = 1;
    printf("1)후위 증감연산자: %d\n", j++); // 우선순위가 printf, 이 명령어가 끝나고 적용이 된다
    printf("2)후위 증감연산자: %d\n", j);
    ...
    int num = -10;
    int absolute = num > 0 ? num : num * -1; // 조건식이 거짓이니까 뒤에 값이 반환됨(-10 * -1 = 10)
